var canvas = document.getElementById("myCanvas");
      ...
      canvas.height = window.innerHeight - Math.floor(innerHeight/3)
      ...
      rtxt = document.getElementById("r")
      ptxt = document.getElementById('p')
      stxt = document.getElementById('s')
      ...
      function draw() {
        ...
        rtxt.textContent = rocks.length
        ptxt.textContent = papers.length
        stxt.textContent = scissors.length
